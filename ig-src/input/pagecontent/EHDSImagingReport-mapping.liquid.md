...
| [EHDSImagingReport](StructureDefinition-EHDSImagingReport.html).[body.examinationReport.adverseReaction](StructureDefinition-EHDSAllergyIntolerance.html) | AdverseEventEuImaging.suspectEntity[procedure];<br/>AdverseEventEuImaging.subjectMedicalHistory[allergy];<br/>AdverseEventEuImaging.status;<br/>AdverseEventEuImaging.code;<br/>AdverseEventEuImaging.subject |  |
