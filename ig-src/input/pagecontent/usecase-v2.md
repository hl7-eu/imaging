A popular way of integrating imaging reports into the hospital based IT system utilizes HL7v2 messages. The IHE-RAD Reporting Workflow [RWF](https://www.ihe.net/uploadedFiles/Documents/Radiology/IHE_RAD_TF_Vol1.pdf#page126)]. The figure below presents the actor diagram of this specification where instead of transactions the corresponding HL7v2 messages are shown.

https://www.ihe.net/uploadedFiles/Documents/Radiology/IHE_RAD_Suppl_RD.pdf page43 shows radiology report.
