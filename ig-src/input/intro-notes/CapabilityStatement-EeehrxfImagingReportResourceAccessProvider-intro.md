...
* When resources are extracted from the FHIR document Bundle and made available as individual resources, follow the [IHE-mXDE](https://profiles.ihe.net/ITI/mXDE/index.html) guidance for generating Provenance resources. A Provenance resource SHOULD identify the extracted resources and their source document.
