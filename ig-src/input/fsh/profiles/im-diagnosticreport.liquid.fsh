...
Description: "If DiagnosticReport.status is 'amended', the referenced Composition SHALL have relatesTo as 'replaces', and status 'final'."
* severity = #error
...
Description: "If DiagnosticReport.status is 'entered-in-error', the referenced Composition SHALL have relatesTo as 'replaces'and status 'entered-in-error'."
* severity = #error
