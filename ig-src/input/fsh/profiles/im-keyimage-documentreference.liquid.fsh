...
{{R4}}* extension[basedOn] contains imorderaccession 0..1
{{R4}}* extension[basedOn][imorderaccession].value[x] only Reference(ImOrder)
{{R4}}  * identifier 1..1
{{R4}}  * identifier only ImAccessionNumberIdentifier
