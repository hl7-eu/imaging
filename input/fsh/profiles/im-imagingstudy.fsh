...
* series
  ...
  * instance
    * extension contains 
      ExtensionImagingStudyInstanceDescription named instance-description 0..1 and
      ExtensionNumberOfFrames named number-of-frames 0..1

Extension: ExtensionImagingStudyInstanceDescription
...
Extension: ExtensionNumberOfFrames
Id: number-of-frames
