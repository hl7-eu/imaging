...
//R5  * bodySite only BodysiteCodeableReferenceEuImaging
  * bodySite
    * extension contains AnatomicalRegion named anatomical-region 1..1
...
//R5Profile: BodysiteCodeableReferenceEuImaging
//R5Parent: CodeableReference
//R5Title: "ImagingStudy: General"
//R5Description: "This profile represents an imaging study instance."
