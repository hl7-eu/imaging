...
//R5* category[imaging]
//R5  * insert SliceCodeableConceptWithRequiredCode( imaging, $sct, #314789007 ) // "Diagnostic imaging equipment"
//R5  * ^short = "Imaging Device"
//R5  * ^definition = "Defines the category of the device as an imaging device."
