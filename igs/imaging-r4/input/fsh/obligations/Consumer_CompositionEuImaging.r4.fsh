...
Description: "Consumer obligations for CompositionEuImaging (R4)"
* custodian
...
error Parent $CompositionEuImaging not found for Consumer_CompositionEuImaging
  File: /home/ignacio/Europa/imaging/igs/imaging-r4/input/fsh/obligations/Consumer_CompositionEuImaging.r4.fsh
  Line: 5 - 52