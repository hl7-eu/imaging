...
//R4Alias: $EuLocation             = http://hl7.eu/fhir/base/StructureDefinition/location-eu
//R4Alias: $EuLocationUrl          = http://hl7.eu/fhir/base/StructureDefinition/location-eu
...
Alias: $EuOrganization         = http://hl7.eu/fhir/base-r6/StructureDefinition/organization-eu-core
Alias: $EuOrganizationUrl      = http://hl7.eu/fhir/base-r6/StructureDefinition/organization-eu-core

Alias: $EuPatient              = http://hl7.eu/fhir/base-r6/StructureDefinition/patient-eu-core
Alias: $EuPatientUrl           = http://hl7.eu/fhir/base-r6/StructureDefinition/patient-eu-core

Alias: $EuPatientCore          = http://hl7.eu/fhir/base-r6/StructureDefinition/patient-core-eu
Alias: $EuPatientCoreUrl       = http://hl7.eu/fhir/base-r6/StructureDefinition/patient-core-eu
...
Alias: $EuPractitionerRole     = http://hl7.eu/fhir/base-r6/StructureDefinition/practitionerRole-eu-core
Alias: $EuPractitionerRoleUrl  = http://hl7.eu/fhir/base-r6/StructureDefinition/practitionerRole-eu-core

Alias: $EuPractitioner         = http://hl7.eu/fhir/base-r6/StructureDefinition/practitioner-eu-core
Alias: $EuPractitionerUrl      = http://hl7.eu/fhir/base-r6/StructureDefinition/practitioner-eu-core
