...
* extension contains http://hl7.org/fhir/5.0/StructureDefinition/extension-DiagnosticReport.study named study 0..*
* extension[study].valueReference only Reference(ImImagingStudy)
* extension[study] ^short = "Study subject to this report"
* extension[study] ^definition = "Study subject to this report. Note: Any associated study (e.g. comparison studies) used during reporting should be tracked in the associatedStudy extension."
