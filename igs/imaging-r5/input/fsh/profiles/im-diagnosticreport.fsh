...
* category[imaging] 
  ...
  * insert SliceCodeableConceptWithRequiredCode( imaging, http://hl7.eu/fhir/eu-health-data-api/CodeSystem/eehrxf-document-priority-category-cs, #Medical-Imaging )
...
//R4* extension[note].valueAnnotation.extension[annotation-type].valueCodeableConcept from ValueSetCompositionSectionCodesEuImaging (preferred)

* note 
  * extension contains $annotation-type named annotation-type 0..*
  * extension[annotation-type].valueCodeableConcept from ValueSetCompositionSectionCodesEuImaging (preferred)
